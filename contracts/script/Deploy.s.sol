...
import {TrollFarmTycoonNFT} from "../src/TrollFarmTycoonNFT.sol";

/// forge script script/Deploy.s.sol:Deploy --rpc-url base_sepolia --broadcast
contract Deploy is Script {
    function run() external returns (TrollFarmTycoonNFT nft) {
        ...
        vm.startBroadcast();
        nft = new TrollFarmTycoonNFT(treasury, royaltyBps, mintFee);
        vm.stopBroadcast();
    }
}
